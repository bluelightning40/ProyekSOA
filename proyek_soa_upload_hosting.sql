...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2020 at 05:17 PM
...
INSERT INTO `player` (`id_player`, `id_team`, `nationality`, `age`, `position`, `player_name`) VALUES
(1, 0, 'Indonesia', 21, 'Goalkeeper', 'Budi');
...
INSERT INTO `teams` (`id_team`, `team_name`, `team_league_id`, `team_logo`) VALUES
(1, 'Rungkut FC', '1', 'adsfasdfa');
...
('abc', 'a@b.c', 'abc', 50, 'BW2h61YbIBlJFlx9e7NsKErU6', 1, '2020-06-14');
...
--
ALTER TABLE `player`
  MODIFY `id_player` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `teams`
--
ALTER TABLE `teams`
  MODIFY `id_team` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
